...
export function buildModel(skills, athletes, assessments) {
...
export async function fetchModel() {
  const [skillsRes, athletesRes, assessmentsRes] = await Promise.all([
  ...
  return buildModel(skillsRes.data || [], athletesRes.data || [], assessmentsRes.data || []);
}
